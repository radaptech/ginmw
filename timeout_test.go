...
// driver do banco. Se alguém trocar por c.Set(...) ou esquecer o
// WithContext, isso quebra.
...
func TestTimeoutTraduz500Em504(t *testing.T) {
	...
	casos := []struct {
		...
		{"prazo estourado vira 504", 20 * time.Millisecond, `{"error":"tempo de resposta esgotado"}`, 504},
		{"erro real segue 500", 0, `{"error":"erro ao logar usuario"}`, 500},
	}
