...
// RateLimit limita a quantidade de requisições por IP usando um token
...
// bruta ou abuso, como login e recuperação de senha — não para limitar
// a API inteira.
func RateLimit(taxa rate.Limit, burst int) gin.HandlerFunc {
